...
starting_message = 'Данный продукт является результатом труда команды разработчиков DDR-crew.' + '\n' +'\n'+ \
                ...
                'Документация к использованию изложена в файле "documentaion.pdf".' + '\n' + '\n' +\
                'Благодарим за то, что выбрали нас!'

rules = 'Вам же сказали, что документация к использованию изложена в файле "documentation.pdf" !!!'
